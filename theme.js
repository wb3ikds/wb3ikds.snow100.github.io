...
var theme = function () {
    ...
    return {
        ...
        initCountDown: function () {
            var austDay = new Date(2019, 4-1, 9);
            austDay = new Date(austDay.getFullYear() + 0, 4 - 1, 9);
        ...
        initGoogleMap: function() {
            ...
            function initialize() {
                var mapOptions = {
                    scrollwheel: false,
                    zoom: 12,
                    center: new google.maps.LatLng(39.949233, -75.166298) // map coordinates
                };
                map = new google.maps.Map(document.getElementById('map-canvas'),
                    mapOptions);
                marker = new google.maps.Marker({
                    position: new google.maps.LatLng(39.949233, -75.166298), // marker coordinates
                    map: map,
                    icon: image,
                    title: 'Hello World!'
                });
